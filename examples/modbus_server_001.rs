...
// use modbus_stack::{decode::request::{RequestDecoder, WriteMultipleRegistersRequestDecoder, WriteSingleRegisterRequestDecoder}, encode::response::{ReadHoldingRegistersReponseEncoder, WriteMultipleRegistersReponseEncoder, WriteSingleRegisterReponseEncoder}, register::{IntoRegIter, RegU16, RegU16Array, RegU32, RW}, tcp::{Frame, Decoder}, ExceptionCode, PduData};
...
//                                     Frame::new_unchecked(&mut out_buffer)
//                                 };
...
//                         if let Ok(req) = RequestDecoder::new(&frame) {
